...
bm=[0,[18,[1,[0,0,b(C)]],[2,0,[17,0,0]]],b(bc)],br=[0,b(bb),365,43],bQ=b(ba),bt=b(")"),bu=b(aB),bv=b(C),bw=b(C),bx=b(G),bO=b(ba),bP=b(bd),bz=b(C),bA=b(G),bB=b($),bD=b(bk),bE=b(aB),bF=b(_),bG=b(G),bH=b($),bI=b(ai),bJ=b(ai),bK=b(bk),bL=b(aB),bM=b(ai),bN=b(_),bC=b(bd),by=b(G),bV=b("div_pol1"),bW=[0,b(bb),477,9],bX=b(P),bY=b("x:"),bZ=b(P),b0=b("r:"),b1=b(P),b2=b("q:"),b3=b(P),b4=b("p:"),b5=b("div_pol:\n"),bT=b(P),bS=b("\n{ "),bU=b("}"),bR=[0,[18,[1,[0,0,b(C)]],[2,0,[17,0,0]]],b(bc)],bs=b(bi),bq=b("non"),bo=[0,0],bp=[0,1],cU=b(P),cT=b(C),cV=b("lp:\n"),cS=b("p: "),cR=b("homogeneous polynomials"),cW=b("computed"),cO=b("new polynomial: "),cN=b(bf),cQ=b(bl),cP=b(G),cM=b("computation of the Groebner basis"),cL=b("coefficient: "),cK=b("verif sum: "),cJ=b("r: "),cG=b("remainder: "),cH=b("polynomial reduced to 0"),cI=b("r ok"),cE=[0,[12,91,[4,3,0,0,[12,44,[4,3,0,0,[12,93,0]]]]],b("[%i,%i]")],cD=[0,0,0],cA=b(" terms"),cB=b(" + "),cz=b(a$),cy=b(a$),cj=b(G),ck=b($),cl=b(ai),ce=b(_),cf=b(_),cg=b(_),ch=b($),ci=b(C),cm=b("-1"),cn=b(G),co=b($),cr=b(bh),cs=b(C),ct=b(aA),cu=b("-"),cp=b("- "),cq=b(bh),cv=b(G),cw=b(C),cx=b(aA),cd=b(aA),cb=b(" i="),cc=b("lv= "),b$=b("]"),ca=b("["),b9=[0,0],b_=[0,1],cF=b("Nsatz_plugin.Ideal.Make(P).NotInIdealUpdate"),b6=b("Nsatz_plugin.Ideal.NotInIdeal"),dx=[0,b(aa),243,9],d3=b("nsatz cannot solve this problem"),d1=b("core.eq.refl"),dZ=b(be),dM=[0,[11,b("number of parameters: "),[4,3,0,0,0]],b("number of parameters: %i")],dJ=[0,[12,120,[4,3,0,0,0]],b("x%i")],dI=b("nsatz: bad parameter"),dQ=b("computation without sugar"),dR=b("computation with sugar"),dS=b("ordre lexico computation without sugar"),dT=b("ordre lexico computation with sugar"),dU=b("computation without sugar, division by pairs"),dV=b("computation with sugar, division by pairs"),dW=b("ordre lexico computation without sugar, division by pairs"),dX=b("ordre lexico computation with sugar, division by pairs"),dK=eb([b("a"),b("b"),b(bf),b("d"),b("e"),b("f"),b("g"),b(bl),b("i"),b("j"),b("k"),b("l"),b("m"),b("n"),b("o"),b("p"),b("q"),b("r"),b("s"),b("t"),b(bi),b("v"),b("w"),b("x"),b("y"),b("z")]),dL=b("cert ok"),dN=b(be),dO=[0,b(aa),484,11],dP=[0,b(aa),472,14],dH=[0,b(aa),501,8],dG=[0,b(aa),439,11],dF=[0,0,0],dE=[0,[11,b("time: "),[18,[1,[0,0,b(C)]],[8,0,[0,1,10],[0,3],[17,0,[12,115,0]]]]],b("time: @[%10.3f@]s")],dD=[0,[11,b("useful spolynomials: "),[4,3,0,0,[12,32,0]]],b("useful spolynomials: %i ")],dC=[0,[11,b("useless spolynomials: "),[4,3,0,0,0]],b("useless spolynomials: %i")],dz=[0,0,0],dA=[0,0,0],dB=b(G),dw=[0,0],c_=b("plugins.setoid_ring.pexpr"),c$=b("plugins.setoid_ring.const"),da=b("plugins.setoid_ring.var"),db=b("plugins.setoid_ring.add"),dc=b("plugins.setoid_ring.sub"),dd=b("plugins.setoid_ring.mul"),de=b("plugins.setoid_ring.opp"),df=b("plugins.setoid_ring.pow"),dg=b("core.list.type"),dh=b("core.list.nil"),di=b("core.list.cons"),dj=b("num.Z.type"),dk=b("num.Z.Z0"),dl=b("num.Z.Zpos"),dm=b("num.Z.Zneg"),dp=b("num.pos.xI"),dr=b("num.pos.xO"),ds=b("num.pos.xH"),dt=b("num.N.N0"),du=b("num.N.Npos"),d9=b(a_),d$=b(a_);function
aC(b){return aj[4][1]?(a(aD[bg],bm,b),c(d[52],d[28])):0}function
...
g(c,b){var
e=K(c);return a(d[6],e,b)}return j(e[20][18],g,c,f)}function
aj(b){var
c=0;function
f(c,b){var
e=K(c);return a(d[6],e,b)}return j(e[20][18],f,b,c)}function
m(c,b){if(0===c[0]){var
f=c[1];if(0===b[0])return a(g[1],f,b[1])}else{var
h=c[2],i=c[1];if(0!==b[0]){var
d=i===b[1]?1:0,k=b[2];return d?j(e[20][37],m,h,k):d}}return 0}function
...
g(e,c){var
f=e+X(c)|0;b[1]=a(d[6],b[1],f);return 0}a(e[20][14],g,f);return b[1]}function
t(b){if(0===b[0])return[0,b[1]];var
c=b[1];return[1,c,a(e[20][15],t,b[2])]}function
v(e,c,a){if(1===a[0]){var
d=a[2];if(a[1]===e)return c<d.length-1?f(d,c)[c+1]:[0,b]}return 0===c?a:[0,b]}function
o(j,c){if(0===j[0]){var
D=j[1];if(0===c[0])var
q=[0,a(g[5],D,c[1])];else{var
s=c[2],E=c[1],u=a(e[20][15],t,s),F=o(j,f(s,0)[1]);f(u,0)[1]=F;var
q=[1,E,u]}var
r=q}else{var
l=j[2],i=j[1];if(0===c[0]){var
x=a(e[20][15],t,l),G=o(f(l,0)[1],c);f(x,0)[1]=G;var
y=[1,i,x]}else{var
z=c[2],m=c[1];if(i<m){var
A=a(e[20][15],t,z),H=o(j,f(z,0)[1]);f(A,0)[1]=H;var
n=[1,m,A]}else
if(m<i){var
B=a(e[20][15],t,l),I=o(f(l,0)[1],c);f(B,0)[1]=I;var
n=[1,i,B]}else{var
...
f=a(e[20][15],L,d[2]);return j(e[20][17],g[12],b,f)}function
M(b,c){if(0===b[0])return[0,a(g[9],b[1],c)];var
d=b[2],f=b[1];function
h(a){return M(a,c)}return[1,f,a(e[20][15],h,d)]}function
Y(c){var
d=L(c);return a(g[1],d,b)?c:M(c,d)}function
Z(b){if(0===b[0])return 0;var
d=b[1],f=c(e[20][11],b[2]),g=[0,[0,d,0],a(e[18][68],Z,f)];return c(e[18][59],g)}function
...
p=function(a){return n(d,a)};return[1,m,a(e[20][15],p,l)]}var
h=d[2],f=d[1];if(0===c[0]){if(a(g[1],c[1],b))return[0,b];var
q=function(a){return n(a,c)};return[1,f,a(e[20][15],q,h)]}var
i=c[1],r=c[2];if(f<i){var
s=function(a){return n(d,a)};return[1,i,a(e[20][15],s,r)]}if(i<f){var
t=function(a){return n(a,c)};return[1,f,a(e[20][15],t,h)]}function
u(b,a){return _(b,f,n(a,c))}var
v=a(e[20][16],u,h);return j(e[20][17],o,[0,b],v)}function
...
d=b[1];return[1,d,a(e[20][15],s,b[2])]}function
...
g=c(aF[1],(b-4|0)+97|0);return a(e[16][1],1,g)}var
h=c(aF[1],b+119|0);return a(e[16][1],1,h)}var
i=[0,0];function
...
p=n[2],m=aa(n[1]),j=[0,bv],h=[0,bw],r=Q(f(p,0)[1]);if(1-a(e[16][34],r,bx))j[1]=r;var
q=[0,0],s=p.length-1-1|0;if(!(s<1)){var
l=s;for(;;){if(0<=i[1]){var
k=Q(f(p,l)[l+1]);h[1]=bz;if(1===l){if(1-a(e[16][34],k,bA)){i[1]=i[1]-1|0;if(a(e[16][34],k,bB))h[1]=m;else
if(a(e[16][22],k,43)){var
z=a(d[17],bD,m),A=a(d[17],k,z);h[1]=a(d[17],bE,A)}else{var
B=a(d[17],bF,m);h[1]=a(d[17],k,B)}}}else
if(1-a(e[16][34],k,bG)){i[1]=i[1]-1|0;if(a(e[16][34],k,bH)){var
...
t=1-c(e[16][40],h[1]),w=t?1-q[1]:t;if(w){i[1]=i[1]-1|0;if(c(e[16][40],j[1]))j[1]=h[1];else{var
y=a(d[17],bC,h[1]);j[1]=a(d[17],j[1],y)}}}else{h[1]=bO;if(1-q[1]){var
N=a(d[17],bP,h[1]);j[1]=a(d[17],j[1],N)}q[1]=1}var
x=l-1|0;if(1!==l){var
l=x;continue}break}}if(c(e[16][40],j[1])){i[1]=i[1]-1|0;j[1]=by}return j[1]}return bQ}function
u(a){i[1]=20;return Q(a)}function
ap(b){var
c=u(b);return a(aD[bg],bR,c)}function
ab(c){var
b=[0,bS];function
f(c){var
e=u(c),f=a(d[17],e,bT);b[1]=a(d[17],b[1],f);return 0}a(e[20][13],f,c);a(d[17],b[1],bU);return 0}function
aq(a){return ab(c(e[20][12],a))}function
...
g=a[2];if(b===a[1]){var
h=function(c,a){return B(c,a,b-1|0)};return j(e[20][17],h,c,g)}}var
...
F(a,b){if(1===a[0]){var
c=a[2];if(a[1]===b){var
d=function(c,a){return B(c,a,b-1|0)};return j(e[20][17],d,k,c)}}return a}function
ae(u,t,r,o,n,b){var
...
b=a[2],d=0;function
f(b,a){return a+R(b)|0}return j(e[20][18],f,b,d)}return[0,I,V,J,ag,ai,r,K,aj,m,W,h,X,t,v,o,L,M,Y,Z,ah,_,n,al,s,N,x,l,O,y,p,am,A,P,an,ao,$,aa,i,u,ap,ab,aq,E,q,ar,as,at,au,ac,F,av,B,ad,ae,af,R,c(D[25],[0,m,R])]}O(166,[0,aG],"Nsatz_plugin__Polynom");var
...
B=c(e[18][51],S),T=[0,B,function(d){function
e(a){return a[1]}var
...
e=[0,0,a(D[1],0,51),0,w(1e3,aq)],i=a(h[27],aw,[0,b,g]);if(i)s(cR);x(function(f){var
...
q(a,d){var
b=n(a),f=c(e[20][12],d),g=o===b?a[1]:l===b?c(m[2],a):a;return c(u[15],[0,g,f])}function
au(f){var
...
k=a[1],p=f(e,k)[k+1];return[0,a[1],p]}}return[0,d,g]},p=j(e[18][15],s,dz,b),h=p[2],a=p[1];if(0===a){var
i=function(a){if(0===a[0])return aQ(c(cY,a[1]));var
b=a[2],f=a[1];function
g(e,b,a){var
g=aR([0,[1,c(d[22],f)],e]);return as([0,a,aS([0,i(b),g])])}return j(e[20][47],g,b,0)},l=i(r);return c(e[18][48],m)?l:as([0,l,g(m)])}var
t=function(i,g){var
b=g[2],j=g[1],k=i[2],l=i[1];if(h<=f(c(J[1],b),a)[a+1]){var
m=c(J[1],b),d=c(e[20][8],m);d[a+1]=f(d,a)[a+1]-h|0;return[0,[0,[0,j,c(J[2],d)],l],k]}return[0,l,[0,[0,j,b],k]]},q=j(e[18][15],t,dA,b),u=q[2],v=q[1],w=1===h?[1,c(d[22],a)]:aR([0,[1,c(d[22],a)],h]),x=g(c(e[18][9],u));return as([0,aS([0,w,g(c(e[18][9],v))]),x])}return aQ(c(k[43],dB))}return g(b)}function
a2(b,a){function
d(b,a){if(b){if(0===b[1]){var
c=b[2];if(a){var
e=a[1];return[0,e,d(c,a[2])]}throw[0,H,dG]}var
f=d(b[2],a);return[0,r[3],f]}return a}var
f=d(b,c(e[18][9],a));return c(e[18][9],f)}function
dY(as){var
u=aZ(as),h=j(e[18][15],dy,0,u);if(u){var
v=u[1];if(typeof
v==="number")var
d=0;else
if(0===v[0]){var
...
X=function(b){return a(I[4],dJ,b+1|0)},Y=a(e[18][56],h,X),Z=[0,a(e[19],dK,Y)],_=function(b){function
d(b){if(typeof
b==="number")var
e=r[3];else
switch(b[0]){case
...
z=b[2],A=d(b[1]),e=a(r[9],A,z)}return e}return d(b)},D=a(e[18][68],_,V);if(D){var
$=D[1],aa=c(e[18][9],D[2]),K=c(r[11][1],12),U=function(b){try{var
...
ad=c(e[18][9],t[3]),F=[0,t[4],ad],i=c(e[18][1],F),p=w(i,0),J=function(b){if(!(i<=b))if(!f(p,b)[b+1]){f(p,b)[b+1]=1;var
c=a(e[18][7],F,b),d=function(e,d){var
c=1-a(r[5],d,r[3]);return c?J((e+b|0)+1|0):c};return a(e[18][12],d,c)}return 0};J(0);var
S=function(b,c){function
d(a,d){if(i<=((b+a|0)+1|0))return 1;var
c=(b+a|0)+1|0;return f(p,c)[c+1]}return f(p,b)[b+1]?[0,a(e[18][63],d,c)]:0},b=a(ap[66],S,F);x(function(f){var
d=i-c(e[18][1],b)|0;return a(I[4],dC,d)});x(function(f){var
d=c(e[18][1],b);return a(I[4],dD,d)});if(b){var
af=b[2],ag=a2(R,b[1]),ah=av(h,a(r[2],h,t[1])),ai=[6,0,t[2]],aj=c(e[18][9],af),ak=function(a){return a2(R,a)},al=a(e[18][68],ak,aj),am=function(a){return av(h,a)},an=c(e[18][68],am),ao=a(e[18][68],an,al),aq=function(a){return av(h,a)},ar=a(e[18][68],aq,ag);x(function(b){return a(I[4],dM,Q)});s(dN);var
aw=a(e[19],[0,[0,ah,[0,ai,ar]],0],ao),ax=function(b){return a(e[18][68],E,b)},ay=a(e[18][68],ax,aw),az=q(aW,[0,au(0),0]),aA=function(d,b){var
...
r=[0,j(e[18][16],p,d,k),[0,b,0]];return q(aX,[0,au(0),r])},aB=j(e[18][16],aA,ay,az);s(dZ);return aB}throw[0,H,dO]}throw[0,H,dP]}var
d=1,G=0}else
var
G=1;if(G)var
d=1}else
