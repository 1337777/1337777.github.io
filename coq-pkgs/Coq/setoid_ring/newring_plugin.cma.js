...
ch=141,X=104,b_="closed",a8="x",b9="ring_lookup",ct=",",J='"',a5="ring",p=250,cs="(",cr="constants",b8="preprocess tactic",aO="Field_tac",cd="with carrier ",cq="postprocess tactic",aN="field",cp="InitialRing",k=246,cc="decidable",A="[",cg='and morphisms "',cm="Pphi_pow",cn='Using setoid "',co="tactic recognizing constants",cl="postprocess",bb="gen_phiZ",aP="setoid",b7="and equivalence relation ",b6=")",B="]",b4=":",b5="t",cb="preprocess",a6="power_tac",ck="Print",ba="power",b3="abstract",cj="Ring_polynom",a7="coq-external/coq-v8.10+32bit/plugins/setoid_ring/newring.ml",aL="sign",a$="protect_fv",b2="PEeval",a_="Ring",aK="div",ca='and "',aM=103,a4="newring_plugin",ce="Add",cf="completeness",a3="IDphi",b$="morphism",ci="field_lookup",b1="Pphi_dev",a9="Coq",H=jA.jsoo_runtime,F=H.caml_check_bound,b=H.caml_new_string,o=H.caml_obj_tag,aJ=H.caml_register_global,z=H.caml_wrap_exception;function
...
gn=[0,0,0],go=[0,0,0],gd=b("field kind"),ge=b(co),gf=b(b8),gg=b(cq),gh=b(aP),gi=b(ba),gj=b(aL),gk=b(aK),gl=b("infinite property"),f5=[0,b(aO),0],f6=[0,0,0],f7=b("field_lemmas"),f8=b("_field_lemma1"),f9=b("_field_lemma2"),f_=b("_field_lemma3"),f$=b("_field_lemma4"),ga=b("_lemma5"),gc=[22,0],gb=[22,0],f4=b("core.eq.congr"),f3=b("field inverse should be declared as a morphism"),fQ=b("arguments of field_simplify do not have all the same type"),fR=[0,b(aN)],fP=[0,b(aO),0],fS=b(J),fT=b(J),fU=b("cannot find a declared field structure over"),fV=[0,b(aN)],fW=[0,b(a7),846,12],fK=[0,1],fL=[0,0],fJ=b("bad field structure"),eN=[0,0,0],eO=[0,0,0],eE=b("ring kind"),eF=b(co),eG=b(b8),eH=b(cq),eI=b(aP),eJ=b(ba),eK=b(aL),eL=b(aK),eD=b(" cannot be set twice"),ex=[0,b("Ring_base"),0],ey=b("ring_lemmas"),ez=b("_ring_lemma1"),eA=b("_ring_lemma2"),eC=[22,0],eB=[22,0],ev=[0,1],ew=[0,0],eu=b("bad ring structure"),ed=b("ring addition should be declared as a morphism"),ee=b("ring multiplication should be declared as a morphism"),ef=b("ring opposite should be declared as a morphism"),eg=b(J),eh=b(ca),ei=b(J),ej=b(J),ek=b('",'),el=b(cg),em=b(J),en=b(cn),eo=b(J),ep=b(ca),eq=b(J),er=b(cg),es=b(J),et=b(cn),d$=b("cannot find setoid relation"),dZ=b("arguments of ring_simplify do not have all the same type"),d0=[0,b(a5)],d1=b(J),d2=b(J),d3=b("cannot find a declared ring structure over"),d4=[0,b(a5)],d5=[0,b(a7),348,12],df=[0,b(cj),0],de=b("newring"),c$=b(a_),c_=b(a_),c6=b("ring: cannot find relation (not closed)"),c5=b("ring: cannot find relation"),cW=b(a8),cV=b(a8),cT=b(a8),cR=b("Ring.exec_tactic: anomaly"),cN=[2,1],cO=[0,1],cI=b(b5),cK=b(b5),cE=[0,b(a7),117,7],cB=b("not found"),cC=b("map "),cD=[0,b("lookup_map")],cx=b("dummy"),cv=b("global_head_of_constr."),cY=b("plugins.setoid_ring.Build_Setoid_Theory"),c0=b("core.option.None"),c1=b("core.option.Some"),c2=b("core.eq.type"),c3=b("core.list.cons"),c4=b("core.list.nil"),c7=b(a9),c8=[0,[0,b("Ring_theory"),0],[0,[0,b(cj),0],[0,[0,b("Ring_tac"),0],[0,[0,b(cp),0],[0,[0,b(aO),0],[0,[0,b("Field_theory"),0],0]]]]]],da=[0,b(a9),0],db=b(cp),dg=b("almost_ring_theory"),dh=b("Eqsth"),dj=b("Eq_ext"),dl=b("Eq_s_ext"),dn=b("ring_theory"),dp=b("mk_reqe"),dr=b("semi_ring_theory"),ds=b("mk_seqe"),du=b("Abstract"),dv=b("Computational"),dx=b("Morphism"),dz=b("inv_morph_nothing"),dA=b("mkhypo"),dC=b("hypo"),dF=b(b2),dI=b(cm),dL=b(b1),dO=b(bb),dR=b(a3),dV=b(a5),dW=b("ring-tac-carrier-table"),dX=b("ring-tac-name-table"),d8=b("tactic-new-ring-theory"),eP=[0,b(a9),0],eQ=b(aO),eV=b("FEeval"),eY=b(b2),e1=b(cm),e4=b(b1),e7=b("display_pow_linear"),e_=b("display_linear"),fb=b(bb),fe=b(a3),fi=b(aN),fl=b("PCond"),fo=b(bb),fr=b(a3),fv=b("field_cond"),fw=b(aN),fy=b("simpl_field_expr"),fA=b("almost_field_theory"),fB=b("field_theory"),fC=b("semi_field_theory"),fD=b("AF_AR"),fF=b("F_R"),fH=b("SF_SR"),fM=b("field-tac-carrier-table"),fN=b("field-tac-name-table"),fZ=b("tactic-new-field-theory"),jb=b(b7),jc=b(cd),ja=b("The following field structures have been declared:"),iP=b(cf),ir=b(b7),is=b(cd),iq=b("The following ring structures have been declared:"),g4=[0,0],gA=b(b3),gB=b(cc),gC=b(b$),gD=b(B),gE=b(A),gF=b(cr),gG=b(B),gH=b(A),gI=b(b_),gJ=b(B),gK=b(A),gL=b(cb),gM=b(B),gN=b(A),gO=b(cl),gP=b(aP),gQ=b(B),gR=b(A),gS=b(a6),gT=b(B),gU=b(A),gV=b(a6),gW=b(aL),gX=b(aK),gs=b(a$),gv=b("in"),gx=b(a$),gz=b(a$),g1=b(cc),g5=b(b3),g9=b(b$),ha=b(B),hd=b(A),hf=b(cr),hi=b(B),hl=b(A),hn=b(b_),hq=b(B),ht=b(A),hv=b(cb),hy=b(B),hB=b(A),hD=b(cl),hI=b(aP),hM=b(aL),hP=b(B),hS=b(A),hV=b(ba),hY=b(B),h1=b(A),h4=b(a6),h8=b(aK),h$=b("ring_mod"),id=b(b6),ig=b(ct),ii=b(cs),il=b("ring_mods"),it=[0,b(ck),[0,b("Rings"),0]],iy=b(b4),iA=b(a_),iB=b(ce),iF=b("AddSetoidRing"),iI=b(B),iK=b(A),iM=b(b9),iO=b(b9),iU=b(cf),iX=b("field_mod"),i1=b(b6),i3=b(ct),i5=b(cs),i8=b("field_mods"),jd=[0,b(ck),[0,b("Fields"),0]],ji=b(b4),jk=b("Field"),jl=b(ce),jp=b("AddSetoidField"),js=b(B),ju=b(A),jw=b(ci),jy=b(ci);function
K(b){var
c=a(d[3],b);return e(Y[6],0,0,c)}function
cu(b,f){var
g=c(h[91],b,f)[1];try{var
j=c(ai[aM],b,g)[1];return j}catch(b){b=z(b);if(b===G){var
...
1:return a(P[24],b);default:return bc(h,f,b)}};if(a(g[20][35],j))return d(-1,b);var
m=c(g[20][16],d,j),n=[5,d(-1,b),m];return a(P[25],n)}return a(P[24],e)}function
bd(b,a){try{var
c=[0,e(g[18][115],j[63][1],a,b)];return c}catch(a){a=z(a);if(a===G)return 0;throw a}}var
aQ=[0,g[16][53][1]];function
aR(b,a){aQ[1]=e(g[16][53][4],b,a,aQ[1]);return 0}function
cA(f){try{var
b=c(g[16][53][22],f,aQ[1]);return b}catch(b){b=z(b);if(b===G){var
h=a(d[3],cB),i=a(d[20],f),j=a(d[3],cC),k=c(d[12],j,i),l=c(d[12],k,h);return e(Y[6],0,cD,l)}throw b}}function
aS(i,g,f,b){function
j(a){return c(_[12],f,a)}var
k=a(h[ch][1],b),l=a(P[33],0),m=e(P[31],[0,j],P[4],g),n=c(cA(i),f,b);function
d(c,f){var
...
aT(a,e,b){var
f=b;for(;;)try{var
m=c(ai[aM],a,f)[1],n=c(j[63][4][3],m,e);return n}catch(b){b=z(b);if(b===G){var
d=c(h[3],a,f);switch(d[0]){case
5:var
f=d[1];continue;case
9:var
k=d[2],i=aT(a,e,d[1]);if(i){var
l=function(b){return aT(a,e,b)};return c(g[20][21],l,k)}return i;default:return 0}}throw b}}var
cG=[0,function(b,s){if(b){var
f=b[2];if(f)if(!f[2]){var
h=f[1],i=a(v[2][2],b[1]),k=a(aj[7],i),m=a(v[2][5],h),n=a(aj[7],m),o=function(b){var
d=a(l[6],t[9]);return c(v[2][7],d,b)},p=c(g[18][68],o,n),r=function(b){if(aT(b,e(g[18][16],j[63][4][4],p,j[63][4][1]),k))return a(q[16],0);var
f=a(d[7],0);return c(cF[65][4],0,f)};return c(q[74][1],q[55],r)}}throw[0,aU,cE]}];e(bi[16],0,bh,cG);var
cH=[0,bh,0];function
bj(b){function
d(a){return[0,c(ao[12],0,a)]}var
e=c(g[18][68],d,b),f=a(l[18],t[9]),h=a(l[5],f),i=[0,[0,c(l[7],h,e)],0],k=[1,a(j[1][6],cI)],m=[0,c(cJ[3],0,k),0],n=a(l[5],t[11]),o=[0,cH,[0,[0,c(l[7],n,m)],i]],p=[31,c(N[1],0,o)];return[28,[0,[0,[0,a(j[1][6],cK)],0],p]]}function
bk(d){var
...
e=a(g[18][5],d),f=a(l[6],t[3]),h=c(v[2][7],f,e);function
i(d){var
e=b[1],f=a(w[22],d),g=c(w[17],cT,f),h=a(j[1][6],g);return c(j[1][11][22],h,e)}bn[1]=c(g[20][2],h,i);return a(q[16],0)}];e(bi[16],0,bo,cU);function
...
m=e(g[18][16],G,D,[0,0,0,j[1][11][1]]),H=m[3],I=m[2],r=a(v[31],0),J=[0,H,r[2],r[3]];function
K(b){var
d=a(w[22],b),e=c(w[17],cW,d);return a(j[1][6],e)}var
L=c(g[18][56],i,K),M=a(l[5],t[3]),O=[0,cS,[0,[0,c(l[7],M,i)],0]],P=[31,c(N[1],0,O)];function
Q(a){return[0,a]}var
R=[5,[28,[0,c(g[18][68],Q,L),P]]],A=h[16],B=a(cP[11],F),f=e(cQ[3][5],E,B,A),C=[0,f[1],f[3]],d=o(b),S=c(g[19],I,[0,R,0]),u=p===d?b[1]:k===d?a(n[2],b):b,x=[0,[0,c(ao[12],0,u)],S],y=[3,c(N[1],0,x)],z=[29,c(N[1],0,y)],T=c(v[23],J,z),U=c(q[73][7],T,C),V=a(cX[2],U),s=a(ac[165],V);function
W(c){var
b=a(v[2][2],c);return b?e(h[5],0,s,b[1]):a(w[3],cR)}var
X=a(ac[150],s);return[0,c(g[20][15],W,bn[1]),X]}function
...
n=[0,m,e(g[20][7],b,0,b.length-1-2|0)],i=a(h[23],n);if(c(h[120][16],f,i)){var
j=b.length-1-1|0,k=b.length-1-2|0,o=F(b,j)[j+1];return[0,i,F(b,k)[k+1],o]}return K(c6)}}return K(c5)}var
ar=[0,c7,[0,aq,0]];function
c9(a){return c(g[19],ar,a)}var
bs=c(g[18][68],c9,c8);function
...
dc=c(g[18][68],j[1][6],[0,db,[0,aq,da]]),dd=a(j[5][4],dc);function
...
b=c[1],d=o(b),e=c[2],f=p===d?b[1]:k===d?a(n[2],b):b;return[0,f,e]},m=c(g[18][68],l,i),q=function(a){return-1===a?1:2},r=[0,[0,cu(d,j),q],m];return function(a){return bd(r,a)}}}var
dD=0;function
dE(b){var
...
ae=a(g[22][1],[0,Z[86]]),aY=e(aw[4],0,dW,ae[1]),ax=e(aw[4],0,dX,U[22][1]);function
dY(a){return c(ae[22],a,aY[1])}function
d6(d){var
...
f=b[1],h=bB[3],i=function(a){return c(h,0,a)};return bj(c(g[18][68],i,f))}var
...
v=e(g[18][16],t,m,s),l=e(az[6],d,b[1],v),w=l[2];b[1]=l[1];var
x=a(h[ch][1],w);return c(_[41],b[1],x)}function
bD(q,b,e){var
f=o(u),s=p===f?u[1]:k===f?a(n[2],u):u,h=c(_[9],b[1],s),i=h[2];b[1]=h[1];if(e){var
j=e[1],d=j[1],t=j[2];if(0===d[0])var
l=a(ag[2],d[1]);else
var
v=d[1],w=bB[3],x=function(a){return c(w,0,a)},l=bj(c(g[18][68],x,v));return[0,l,r(b,aX,[0,i,aA(q,b,L(t))])]}var
...
N=J[2],P=J[1],R=M[2],f=M[1],ax=c(g[19],ar,ex);a(O[12],ax);var
...
6:return s(eK,i,a[1]);default:return s(eL,k,a[1])}}c(g[18][11],m,o);var
...
j=e(g[18][16],i,d,h),c=e(az[6],f,a[1],j),k=c[2];a[1]=c[1];return k}function
y(b){var
...
K=bL(f,k,a(h[9],l[1]),i),L=a(v[2][1],K),M=y(bC(f,k,I)),N=eM(l),O=c(g[19],N,[0,M,[0,L,0]]),P=c(v[2][8],J,O),Q=a(q[67][1],k[1]),R=c(q[18],Q,P);return R}throw[0,aU,d5]}catch(b){b=z(b);if(a(q[73][9],b))return c(q[21],0,b);throw b}}return a(q[69][8],b)}var
eR=c(g[18][68],j[1][6],[0,eQ,[0,aq,eP]]),eS=a(j[5][4],eR),eT=0;function
eU(b){var
...
d=c(g[18][68],b,fu);return function(a){return bd(d,a)}});function
...
fO(a){return c(ae[22],a,aZ[1])}function
fX(d){var
...
6:return s(gj,az,a[1]);default:return s(gk,aE,a[1])}}return s(gl,ay,L(b[1]))}c(g[18][11],bo,br);var
aF=at[1],R=aF?aF[1]:0,aG=aE[1],aH=az[1],aI=aA[1],aJ=ax[1],aK=aw[1],aL=av[1],aM=ay[1],bq=au[1],aS=c(g[19],ar,f5);a(O[12],aS);var
...
b(m){var
b=a(bN[35][4],m),f=a(q[69][4],m);try{var
i=bK(b,I,H),k=[0,b],n=c(g[19],ar,fP);a(O[12],n);if(i){var
o=i[2],j=E(aa[2],0,0,f,b,i[1]),p=function(g){var
h=E(aa[2],0,0,f,b,g),c=1-E(bv[81],0,f,b,j,h);if(c){var
i=a(d[3],fQ);return e(Y[6],0,fR,i)}return c};c(g[18][11],p,o);try{var
...
L=bL(f,k,a(h[9],l[1]),i),M=a(v[2][1],L),N=y(bC(f,k,J)),P=gm(l),Q=c(g[19],P,[0,N,[0,M,0]]),R=c(v[2][8],K,Q),S=a(q[67][1],k[1]),T=c(q[18],S,R);return T}throw[0,aU,fW]}catch(b){b=z(b);if(a(q[73][9],b))return c(q[21],0,b);throw b}}return a(q[69][8],b)}aJ(307,[0,bg,be,bJ,ax,bM,bO,aE,bP],"Newring_plugin__Newring");a(gp[9],an);var
gq=0;function
...
iG=0;function
iH(e,d,c,f){var
b=a(g[18][aM],c);return bM(e,d,b[2],b[1])}var
...
jq=0;function
jr(e,d,c,f){var
b=a(g[18][aM],c);return bP(e,d,b[2],b[1])}var
