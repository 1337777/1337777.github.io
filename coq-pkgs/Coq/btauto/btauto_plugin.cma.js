...
O=141,ab="core.bool.type",j=250,g=246,aa="to_list",$="btauto",n=bg.jsoo_runtime,o=n.caml_check_bound,b=n.caml_new_string,i=n.caml_obj_tag,S=n.caml_register_global,_=n.caml_wrap_exception;function
...
a9(o){var
P=a(z[69][2],o),Q=a(p[O][1],P),l=a(x[34][3],o),r=i(t),R=j===r?t[1]:g===r?a(h[2],t):t,s=i(q),S=j===s?q[1]:g===s?a(h[2],q):q,m=B(l,Q);if(9===m[0]){var
...
l=i(t),n=a(z[69][2],e),o=j===l?t[1]:g===l?a(h[2],t):t,q=a(p[O][1],n),b=B(a(x[34][3],e),q);if(9===b[0]){var
m=b[2];if(3===m.length-1){var
s=m[2];if(c(k,b[1],o)){var
u=function(a){return aT(s,f,a)},v=c(z[73][1],0,u);return c(y[65][11],N[123],v)}}}var
r=a(d[3],a8);return c(y[65][4],0,r)},ad=[0,a(z[69][8],L),ac],C=i(M),ae=[0,N[68],ad],af=j===C?M[1]:g===C?a(h[2],M):M,ag=a(p[9],af),ah=[0,a(N[87],ag),ae],ai=[0,a(N[54],ab),ah];return a(y[65][22],ai)}}}var
T=a(d[3],a_);return c(y[65][4],0,T)}var
Z=[0,a(z[69][8],a9)];S(65,[0,Z],"Btauto_plugin__Refl_btauto");a(a$[9],R);var
