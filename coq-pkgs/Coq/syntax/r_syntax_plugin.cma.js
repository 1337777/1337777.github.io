...
m(b){var
d=c(n[18][14],f[1][6],b);return a(f[5][4],d)}function
g(g,d){var
...
0:var
P=q(n[16][4],d,2,p(d)-2|0),A=a(b[1],P),m=1;break;case
1:var
k=0,m=0;break;default:var
Q=q(n[16][4],d,2,p(d)-2|0),R=a(b[1],Q),A=a(b[22],R),m=1}if(m)var
z=A,k=1}if(!k)var
O=q(n[16][4],d,1,p(d)-1|0),z=a(b[1],O);var
x=z}var
